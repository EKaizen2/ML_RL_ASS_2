...
def train_agent(fourRoomsObj, agent, num_episodes, max_steps, is_softmax=False):
    ...
    return best_episode_index, best_episode_steps
...
def main():
    ...
    best_episode_epsilon, best_steps_epsilon = train_agent(fourRoomsObj_epsilon, epsilon_agent, 1000, 1000, False)
    ...
    best_episode_softmax, best_steps_softmax = train_agent(fourRoomsObj_softmax, softmax_agent, 1000, 1000, True)
